...
CREATE TABLE payment_schedules (
  ...
  -- weekly/biweekly: day name e.g. 'monday', 'friday'
  -- monthly: day-of-month e.g. '1', '15', '28'
...
CREATE INDEX idx_schedules_enterprise_id ON payment_schedules(enterprise_id);
CREATE INDEX idx_schedules_next_run_at ON payment_schedules(next_run_at) WHERE status = 'active';
CREATE INDEX idx_schedule_items_schedule_id ON payment_schedule_items(schedule_id);
